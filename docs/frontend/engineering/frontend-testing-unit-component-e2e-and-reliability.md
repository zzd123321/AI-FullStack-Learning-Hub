...
## 七、异步测试的核心是等待条件，不是等待时间

### 7.1 禁止用任意 Sleep 猜系统完成时间
...
### 12.1 Locator 是可重新求值的查询，不是旧 DOM 引用
...
下一节将进入前端性能工程，系统学习 Core Web Vitals、Performance API、资源加载、代码分割、运行时长任务与持续性能预算。
